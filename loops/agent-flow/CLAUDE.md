# CLAUDE.md — agent-flow loop

Instructions for Claude Code instances working in the agent-flow build loop.

## Loop location

- Loop workspace: `loops/agent-flow/`
- Build target: `loops/agent-flow/agent-flow/`
...
- **agent-flutter as abstraction**: agent-flow never touches VM Service directly.
