#!/usr/bin/env bash
# Eval harness for agent-flow Phase 11 (verify correctness + desktop video + YAML multi-line).
# Usage: bash loops/agent-flow/eval11.sh
