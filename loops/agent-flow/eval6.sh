#!/usr/bin/env bash
# Eval harness for agent-flow Phase 6 (Agent-friendly run data + app metadata).
# Usage: bash loops/agent-flow/eval6.sh
...
echo "=== agent-flow Phase 6 eval ==="

# ── Gate 1: Phase 5 still passes ──
echo ""
echo "── Gate 1: Phase 5 regression ──"
check "Phase 5 eval passes" bash loops/agent-flow/eval5.sh
