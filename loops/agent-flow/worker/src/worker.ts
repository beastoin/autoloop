// agent-flow Worker: store and serve HTML reports via R2, landing page with live metrics
...
<title>agent-flow — Map your app in minutes. Zero test code.</title>
<style>
...
<div class="container">
  <section class="hero">
    ...
    <code class="install">npm install -g agent-flow-cli</code>
  </section>
  ...
  <section class="tryit">
    <h2>See it work</h2>
    <div class="terminal">
      <div><span class="prompt">$ </span><span class="cmd">agent-flow walk --max-depth 2</span></div>
      <div><span class="out">&rarr; discovered 26 screens, 44 edges in 4 minutes</span></div>
      <br>
      <div><span class="prompt">$ </span><span class="cmd">agent-flow run flows/tab-navigation.yaml</span></div>
      <div><span class="out">&rarr; 6/6 steps pass (14.2s)</span></div>
      <br>
      <div><span class="prompt">$ </span><span class="cmd">agent-flow push ./results/</span></div>
  ...
  <section class="recent">
    ...
    ${recentRows || '<div class="empty">No reports yet. Be the first: <code>agent-flow push</code></div>'}
  </section>

  <footer class="footer">
    <p>Open source &middot; MIT &middot; <a href="https://github.com/beastoin/agent-flow">GitHub</a> &middot; <a href="${baseUrl}/api/stats">API</a></p>
