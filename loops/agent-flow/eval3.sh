#!/usr/bin/env bash
# Eval harness for agent-flow Phase 3 (Agent-grade foundation).
# Applies Poehnelt principles: structured errors, input hardening, schema, TTY-aware JSON.
# Usage: bash loops/agent-flow/eval3.sh
...
echo "=== agent-flow Phase 3 eval ==="

# ── Gate 1: Phase 2 still passes ──
echo ""
echo "── Gate 1: Phase 2 regression ──"
check "Phase 2 eval passes" bash loops/agent-flow/eval2.sh
