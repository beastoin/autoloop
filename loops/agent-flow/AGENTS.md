# AGENTS.md — agent-flow

## What this project does

`agent-flow` automatically maps a Flutter app's navigation structure by
...
agent-flow walk --app-uri ws://127.0.0.1:12345/ws --dry-run

# Walk one level deep
agent-flow walk --bundle-id com.friend.ios.dev --max-depth 1 --output-dir ./flows/

# Full recursive walk with custom blocklist
agent-flow walk --app-uri ws://... --max-depth 5 --blocklist "delete,sign out,reset"
```
