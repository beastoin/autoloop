...
```text
agent-flow walk --name <flow-name> --output <file.yaml>
...
agent-flow record|verify|report|push|migrate
...
- `loops/agent-flow/agent-flow/.phase7-contract-core`
- `loops/agent-flow/agent-flow/src/flow-v2-schema.ts`
- `loops/agent-flow/agent-flow/tests/flow-v2-schema.test.ts`
- `loops/agent-flow/agent-flow/tests/cli-v2-contract.test.ts`
- `loops/agent-flow/agent-flow/tests/walk-v2.test.ts`

### Modify

- `loops/agent-flow/agent-flow/src/cli.ts`
- `loops/agent-flow/agent-flow/src/command-schema.ts`
- `loops/agent-flow/agent-flow/src/errors.ts`
- `loops/agent-flow/agent-flow/src/types.ts`
- `loops/agent-flow/agent-flow/src/flow-parser.ts`
- `loops/agent-flow/agent-flow/src/walker.ts`
- `loops/agent-flow/agent-flow/src/yaml-writer.ts`
- `loops/agent-flow/agent-flow/tests/command-schema.test.ts`
- `loops/agent-flow/agent-flow/tests/flow-parser.test.ts`

### Delete

- `loops/agent-flow/agent-flow/src/runner.ts`
- `loops/agent-flow/agent-flow/src/capture.ts`
- `loops/agent-flow/agent-flow/tests/runner.test.ts`
- `loops/agent-flow/agent-flow/tests/capture.test.ts`

## Acceptance criteria (gates)

1. **Phase sentinel exists**: `agent-flow/.phase7-contract-core` exists and contains exactly `phase7_contract_core_complete=yes`.
...
4. **CLI surface is v2-only**: `agent-flow schema` advertises exactly `walk, record, verify, report, push, migrate, schema`; `run` and `get` are not accepted subcommands.
...
6. **Walk generates v2 scaffold offline**: `agent-flow walk --name <x> --output <path>` writes YAML containing `version: 2` and step fields `id`, `do`, `anchors`, `expect`, `evidence` without requiring device connectivity.
