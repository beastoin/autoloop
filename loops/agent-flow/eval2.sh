#!/usr/bin/env bash
# Eval harness for agent-flow Phase 2 (Run + Report).
# Usage: bash loops/agent-flow/eval2.sh
...
echo "=== agent-flow Phase 2 eval ==="

# ── Gate 1: Phase 1 still passes ──
echo ""
echo "── Gate 1: Phase 1 regression ──"
check "Phase 1 eval passes" bash loops/agent-flow/eval.sh
