#!/usr/bin/env bash
# Eval harness for agent-flow Phase 4 (Hosted reports — push command).
# Usage: bash loops/agent-flow/eval4.sh
...
echo "=== agent-flow Phase 4 eval ==="

# ── Gate 1: Phase 3 still passes ──
echo ""
echo "── Gate 1: Phase 3 regression ──"
check "Phase 3 eval passes" bash loops/agent-flow/eval3.sh
